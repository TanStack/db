...
This is the separate-result ownership form from the [grammar](./grammar/brief.md), selected for this draft under the user's implementation authorization. The grammar itself did not rank its forms.
...
- Research and analytical controls: [survey](./representation-survey.md), [grammar model](./grammar/model.md), [evidence](./grammar/evidence.md), [process](./grammar/process.md).
