...
import { runCheck, sha256 } from '../../delivery.mjs'
...
function receive(message) {
  ...
  if (message.method === 'initialize') send({ id: message.id, result: { capabilities: { textDocumentSync: { openClose: true, change: 1, save: { includeText: true } } }, serverInfo: { name: 'real-endpoints-native-probe', version: '0.2.0' } } })
