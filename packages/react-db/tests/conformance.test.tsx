...
const reactDriver: LiveQueryDriver = {
  ...
  mountConfig,
  mountDisabled,
  // React eagerly starts sync on mount, so a "non-syncing" pre-created
  // collection is readied anyway — it can't stay isReady=false the way Vue's
  // does. Real cross-adapter drift, surfaced by the suite; not hidden.
  knownGaps: [`precreated-not-syncing-isready-false`],
