# @tanstack/electron-db-persistence
...
Use `@tanstack/electron-db-persistence/main` and
`@tanstack/electron-db-persistence/renderer` if you prefer
...
import { exposeElectronSQLitePersistence } from '@tanstack/electron-db-persistence/main'
...
} from '@tanstack/electron-db-persistence'
