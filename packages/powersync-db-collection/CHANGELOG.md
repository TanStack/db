...
- Require PowerSync 2 and fix update conservation, declared-view rows, transformed-schema comparison, and portable inferred declarations. ([#1831](https://github.com/TanStack/db/pull/1831))
