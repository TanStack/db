...
): Omit<CollectionConfig<InferSchemaOutput<T>, string | number, T, ElectricCollectionUtils<InferSchemaOutput<T>>>, `utils`> & {
  id?: string
...
): Omit<CollectionConfig<T, string | number, never, ElectricCollectionUtils<T>>, `utils`> & {
  id?: string
