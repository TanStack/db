...
var TanstackDbDevtools = class {
  constructor(config) {
    ...
    __privateSet(this, _panelProps, createSignal(panelProps));
    __privateSet(this, _toggleButtonProps, createSignal(toggleButtonProps));
    __privateSet(this, _closeButtonProps, createSignal(closeButtonProps));
    __privateSet(this, _storageKey, createSignal(storageKey));
    __privateSet(this, _panelState, createSignal(panelState));
    __privateSet(this, _onPanelStateChange, createSignal(onPanelStateChange));
  }
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component)) {
        DbDevtools = __privateGet(this, _Component);
      } else {
        DbDevtools = lazy(() => import("./DbDevtools-P3PATHG2.js"));
        __privateSet(this, _Component, DbDevtools);
      }
      return /* @__PURE__ */ jsx(
        DbDevtools,
        {
...
export {
  ...
  DEFAULT_SORT_ORDER,
  DEFAULT_WIDTH,
  DbDevtools_default as DbDevtools,
  DbDevtoolsPanel,
  INITIAL_IS_OPEN,
  POSITION,
  TanstackDbDevtools,
