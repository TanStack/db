# @tanstack/capacitor-db-persistence
...
} from '@tanstack/capacitor-db-persistence'
...
- `pnpm --filter @tanstack/capacitor-db-persistence test:e2e`
  runs the package e2e suite against the default `better-sqlite3` harness.
- `pnpm --filter @tanstack/capacitor-db-persistence test:e2e:ios`
...
- `pnpm --filter @tanstack/capacitor-db-persistence test:e2e:android`
