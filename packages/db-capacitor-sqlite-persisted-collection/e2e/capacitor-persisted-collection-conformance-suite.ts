...
type CapacitorPersistedCollectionTestConfig = E2ETestConfig
...
type CapacitorPersistenceFactory = <T extends PersistableRow>(
...
export function runCapacitorPersistedCollectionConformanceSuite(
  ...
  let config: CapacitorPersistedCollectionTestConfig | undefined
  ...
  function getConfig(): Promise<CapacitorPersistedCollectionTestConfig> {
    if (!config) {
