...
describe(`findOne() with joins - Type Safety`, () => {
  ...
  test(`findOne() with rightJoin should not result in never type`, () => {
    const usersCollection = createUsersCollection()
    const departmentsCollection = createDepartmentsCollection()
  ...
  test(`findOne() with fullJoin should not result in never type`, () => {
    const usersCollection = createUsersCollection()
    const departmentsCollection = createDepartmentsCollection()
  ...
  test(`findOne() with multiple joins should not result in never type`, () => {
    const usersCollection = createUsersCollection()
    const departmentsCollection = createDepartmentsCollection()
    ...
    const projectsCollection = createCollection(
      mockSyncCollectionOptions<Project>({
        id: `test-projects-findone-multi`,
        getKey: (project) => project.id,
        initialData: [],
      })
    )
    ...
    const query = createLiveQueryCollection({
      query: (q) =>
        q
          ...
          .innerJoin({ project: projectsCollection }, ({ user, project }) =>
            eq(user.id, project.user_id)
          )
          .findOne(),
    })
  ...
  test(`findOne() with select() and joins should not result in never type`, () => {
    const usersCollection = createUsersCollection()
    const departmentsCollection = createDepartmentsCollection()
  ...
  test(`findOne() called before select() with joins should not result in never type`, () => {
    const usersCollection = createUsersCollection()
    const departmentsCollection = createDepartmentsCollection()
