 ...
 * "  h", " he", "hel", "ell", "llo", "o  "
 */
export class TrigramIndex extends BaseIndex {
    constructor() {
        super(...arguments);
     ...
     */
    calculateSimilarity(trigrams1, trigrams2) {
     ...
     */
    likeToRegex(pattern, caseInsensitive = false) {
     ...
     */
    likeLookup(pattern, caseInsensitive) {
