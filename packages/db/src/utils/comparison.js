 ...
 */
export const ascComparator = (a, b) => {
 ...
 */
export const descComparator = (a, b) => {
    // Handle null/undefined cases first (treat them as larger than any other value in desc order)
    if (a == null && b == null)
        return 0;
    if (a == null)
        return 1;
