...
Use explicitly declared and validated collection key paths for direct join lookups, and retain query-backed rows until their explicit owners release them.
