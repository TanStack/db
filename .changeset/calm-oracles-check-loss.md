...
Use collection key accessors for direct join lookups without a duplicate key-path declaration, and retain query-backed rows until their explicit owners release them.
