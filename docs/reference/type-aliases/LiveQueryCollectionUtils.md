...
Defined in: [packages/db/src/query/live/collection-config-builder.ts:44](https://github.com/TanStack/db/blob/main/packages/db/src/query/live/collection-config-builder.ts#L44)
