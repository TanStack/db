...
Defined in: [packages/electric-db-collection/src/electric.ts:528](https://github.com/TanStack/db/blob/main/packages/electric-db-collection/src/electric.ts#L528)
