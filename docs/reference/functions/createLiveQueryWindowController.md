...
Defined in: [packages/db/src/live-query-window-controller.ts:1035](https://github.com/TanStack/db/blob/main/packages/db/src/live-query-window-controller.ts#L1035)
