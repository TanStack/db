---
id: isLiveQueryWindowCollection
...
Defined in: [packages/db/src/live-query-window-controller.ts:389](https://github.com/TanStack/db/blob/main/packages/db/src/live-query-window-controller.ts#L389)
