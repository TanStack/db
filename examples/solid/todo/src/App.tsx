import { useLiveQuery, useOptimisticMutation } from "@tanstack/solid-db"
import {
...
import type { Collection, PendingMutation } from "@tanstack/solid-db"
    ...
    <>
      ...
      >
        <div style={{ width: "550px" }} class="mx-auto relative">
          <h1
            class="text-[100px] font-bold text-center mb-8"
          ...
          <div class="mb-6 flex justify-center">
            <div class="flex flex-col bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
              <div class="px-4 py-2 bg-gray-100 border-b border-gray-200 text-center">
              ...
              <div class="flex">
                ...
                >
                  <span>Query</span>
                  {collectionType === CollectionType.Query && (
                    <span class="absolute bottom-0 left-2 right-2 h-0.5 bg-blue-600"></span>
                  )}
                </button>
                <button
                  onClick={() =>
